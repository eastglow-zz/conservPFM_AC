...
double SIGSV = 1.;
double SIGLV = 1.;
//double SIGSL = 0.2014;//37deg
double SIGSL = 1.;//90deg
...
void initialize(double p[nphase][nxtot][nytot][nztot])
{
	...
	clean_all(p); 
        ...
        fill_rectangular(2,p,nx/2,ny/2,40+10,92,116,20);
        fill_environ(0,p);
        relax_p(p, 50);
        //clean_one(p[0]);
        //fill_rectangular(2,p,nx/2,ny/2,20+38,80,80,80);
        //fill_cylinder(2,p,nx/2,ny/2,20+15-2,'z',48,30);
        //fill_environ(0,p);
}
